...
function enqueue_aj_scripts(){
    ...
    wp_register_style( 'prettyphoto-css', plugin_dir_url( dirname(__FILE__) ) . 'public/css/prettyPhoto.css', false, '1.0.0' );
    ...
    wp_register_script( 'prettyphoto-js', plugin_dir_url( dirname(__FILE__) ) . 'public/js/jquery.prettyPhoto.js' ); 
