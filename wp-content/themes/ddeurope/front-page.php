    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 img-block">
                ...
                <div class="overlay">
                    <h6 class="grid-title">ACG_PROPAK</h6>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 img-block">
