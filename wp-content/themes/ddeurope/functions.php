...
function enqueue_theme_styles() {
    ...
    wp_enqueue_style('lightgallery', get_template_directory_uri() . '/assets/css/lightgallery.min.css', array(), '', false);
}
...
function enqueue_theme_scripts() { 
    ...
    wp_register_script( 'lightgallery-js', get_template_directory_uri().'/assets/js/lightgallery-all.min.js', array(), '', true);
    wp_register_script( 'frontpage-js', get_template_directory_uri().'/assets/js/front-page.js' , '', '', true );
    wp_register_script( 'picturefill-js', get_template_directory_uri().'/assets/lib/picturefill.min.js' , '', '', true );
    wp_register_script( 'mousewheel-js', get_template_directory_uri().'/assets/lib/jquery.mousewheel.min.js' , '', '', true );
