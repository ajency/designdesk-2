...
<div class="page_content">
	...
	<div class="container">
		<div class="head_text">
			<h2 class="title"> Expert Tips for Exhibition Stands with <span>Big Products or Large Size Exhibits.</span> </h2>
			<h4>Are you going to exhibit heavy machinery or large size products at your next trade show ?</h4>
		</div>
		<div class="row experts_tips">
...
<!-- 			<?php echo do_shortcode('[portfolio_gallery post="396" lightbox=true]'); ?>
 -->			<strong>Key Features: </strong>
	...
	<div id="call-to-action" class="main-text pb-1">
